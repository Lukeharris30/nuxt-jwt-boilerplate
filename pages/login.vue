...
<template>
  <section>
    ...
    <div v-show="u.user" class="q-pa-md q-gutter-sm column-inline items-center">
      <q-btn v-if="u?.user?.userType==='msal'" @click="msalLogout">Logout</q-btn>
      <q-btn class="g_id_signout" id="logoutGoogle" v-show="u?.user?.userType==='google'" @click="logoutGoogle">Logout</q-btn>
    </div>
  </section> 
</template>
